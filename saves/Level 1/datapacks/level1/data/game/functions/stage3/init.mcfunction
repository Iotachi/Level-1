...
scoreboard objectives add hasPaintball dummy
...
summon minecraft:item 176 95 10 {Item:{id:"minecraft:snowball",Count:1},Tags:["isPaintballGiver","stage3Kill"],Age:-2137486526,PickupDelay:2137486527}