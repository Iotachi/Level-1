...
execute if score #stage functionActive matches 7 run function game:stage7/main
execute if score #stage functionActive matches 8 run function game:stage8/main
