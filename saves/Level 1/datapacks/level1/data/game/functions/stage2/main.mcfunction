...
execute as @a[x=134,y=105,z=39,dx=20,dy=1,dz=4,scores={ignoreTrack=0,atFinish=0}] run function game:player/reach_finish
...
scoreboard players set @a[tag=ignoreRhythm] rhythm 0
scoreboard players set @a[scores={ignoreTrack=0,atFinish=2..}] rhythm 0

# Timing for jumps
scoreboard players add @a[tag=!ignoreRhythm,scores={ignoreTrack=0,atFinish=..1}] rhythm 1
